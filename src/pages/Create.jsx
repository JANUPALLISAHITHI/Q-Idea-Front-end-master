...
//           <label>Write a hint for your idea (max 150 characters)</label>
//           <input
//             type="text"
//             value={hint}
//             onChange={(e) => setHint(e.target.value)}
//             maxLength={maxHintLength}
//             placeholder="Ex: An app that helps people donate surplus food..."
//           />
...
//         <div className={styles.formGroup}>
//           <label>Give hashtags to your idea</label>
//           <input
//             type="text"
//             value={hashtags}
...
//         <div className={styles.formGroup}>
//           <label>Lock your idea in a time capsule</label>
